...
type Reducer<iGlobalState, GlobalActions> = (prevState: iGlobalState, action: GlobalActions) => iGlobalState;

const GlobalContextProvider = ({ children }: any) => {
  const [state, dispatch] = useReducer<Reducer<iGlobalState, any>>(reducer, initialState);
