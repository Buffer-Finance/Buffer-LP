  ...
  return (
    <Wrapper>
      <div className="full-width content-sbw main-wrapper persp">
        ...
        <div className="flex gap-[20px] justify-center mt-6">
          <a
            href="https://app.buffer.finance/#/lp-rewards"
            target="_blank"
            className={activeTab == 2 || activeTab == 1 ? "sm:hidden" : ""}
          >
            <div className="bg-[#010633] text-center text-[18px] font-bold  p-2 text-[#B1B6C6] max-w-[290px] min-w-[290px] px-[20px] py-[10px] rounded-[20px] ">
              {" "}
              🚀 &nbsp;BLP Yield Boost Rewards Are Live <span className="text-1">26,900 $ARB</span> to be earned ↗️
            </div>
          </a>
          <a
            href="https://app.buffer.finance/#/leaderboard/galxe"
            target="_blank"
            className={activeTab == 0 || activeTab == 2 ? "sm:hidden" : ""}
          >
            <div className="bg-[#010633] text-center text-[18px] font-bold  p-2 text-[#B1B6C6] max-w-[290px] min-w-[290px] px-[20px] py-[10px] rounded-[20px] ">
              {" "}
              <LeaderboardTropy /> Coming Soon: League based competitions with a prize pool of{" "}
              <span className="text-1">19,724 ARB</span> ↗️
            </div>
          </a>
          <a
            href="https://app.buffer.finance/"
            target="_blank"
            className={activeTab == 0 || activeTab == 1 ? "sm:hidden" : ""}
          >
            <div className="bg-[#010633] text-center text-[18px] font-bold  p-2 text-[#B1B6C6] max-w-[290px] min-w-[290px] px-[20px] py-[10px] rounded-[20px] ">
              {" "}
              ✨ Trades above 20 ARB are eligible. jackpot. Prize Pool <span className="text-1">10,000 ARB</span>
            </div>
          </a>
          {/* <div className="mt-5 subtxt text-f18 text-2 sm:text-f16">
            Buffer Finance is a non-custodial, exotic options trading platform built to trade short-term price
